...
export default function Index() {
  ...
  return <div className="case-study"><div className="sheet">
    ...
    <section className="abstract"><div className="doc-row"><aside className="margin-col"><span className="sec-num">Abstract</span></aside><div className="content-col"><div className="abstract-box">The problem. The page opened with a big hero. Services were hidden below it, behind gray service tabs that made one option look already chosen. Most visitors never scrolled past this first screen.<br /><br /><span className="abstract-sources"><span>Library</span><span>Paid</span><span>Organic</span></span><br /><br />The fix. Rebuilt the first fold to lead with services, equalized tab weight, and shipped a dev-ready page in under a month.<br /><br /><a href="#figma-design-file">Figma - Design File</a><br /><br />Figma - Design file for the Meridian PPC LP Optimisation project.</div></div></div></section>
    ...
    <Section number="II." label="The Signal" title="Most visitors never scroll past the first fold"><p>Microsoft Clarity insights showed a consistent pattern across visits: the large majority of users did not scroll past the first fold. Whatever content sat below roughly 900px was, for most sessions, effectively invisible.</p><p className="signal-quote">→ If it isn&apos;t visible in the first screen, most visitors never see it.</p><p className="signal-cite">Reframed the brief from “redesign the page” to “fix the first fold.” The goal was clear: fix the first fold and reduce drop-offs.</p></Section>
