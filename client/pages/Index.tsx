  ...
  return (
    <div className="case-study"><div className="sheet">
      <header className="masthead">
        ...
        <p className="doc-sub">Most people never scrolled past screen one. I redesigned it to sell the service, and the team shipped it.</p>
          ...
          <div className="content-col">
            <div className="abstract-box">
              <p className="abstract-problem">
                <strong>The problem.</strong> The page opened with a big hero. Services were hidden below it, behind gray service tabs that made one option look already chosen. Most visitors never scrolled past this first screen.
              </p>
      ...
      <Section number="I." label="The Brief" title="Services are the product, not the story">
        ...
        <p>I was the product designer and design point of contact. I owned this from the first research session to the shipped page, working closely with the growth PM and marketing team. This case study covers that whole journey, not just the file.</p>
      </Section>
