...
export default function Index() {
  ...
  return <div className="case-study"><div className="sheet">
    <header className="masthead">
      <div className="masthead-top"><span>Product Design - Case Study</span><a className="inline-flex items-center rounded-full border-[3px] border-[var(--navy)] bg-[var(--redsoft)] px-6 py-2 font-semibold tracking-[0.1em] text-[var(--ink)] no-underline transition hover:brightness-95" href="https://www.figma.com/design/1ueYeizVcNp9GNW1Ml90Mq/Meridian-PPC-LP-Optimisation?node-id=0-1&amp;t=SQ5DrrxjK2bwkkc2-1" target="_blank" rel="noopener noreferrer">View Design</a></div>
    ...
    <footer className="colophon"><div className="colophon-grid"><div><b>Project</b>Meridian Editorial - Services Landing Page<br />Optimization cycle, Jul 2026</div><div><b>Role</b>Solo Product Designer<br />End-to-end, brief to shipped</div><div><b>Method</b>Microsoft Clarity session review<br />Figma, dev handoff</div></div><div className="mt-10 flex flex-wrap items-center gap-6 text-sm font-semibold uppercase tracking-[0.08em]"><span className="text-[var(--green)]">Thank you for reading.</span><nav aria-label="Social and professional links" className="flex flex-wrap gap-5"><a href="https://www.instagram.com/feyaxdesigns/" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] no-underline transition hover:text-[var(--green)]">Instagram</a><a href="https://medium.com/@fyydoshi" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] no-underline transition hover:text-[var(--green)]">Medium</a><a href="https://docs.google.com/document/d/1kqhsZcNHAPhXttOyTlir6gJJM1FLG29F/edit?usp=sharing&amp;ouid=106109041708842757722&amp;rtpof=true&amp;sd=true" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] no-underline transition hover:text-[var(--green)]">Resume</a></nav></div><p className="fine">Client name changed to protect confidentiality - the design decisions, data, and outcomes described are unchanged. This case study will be updated with post-launch performance once a full reporting cycle is available.</p></footer>
  </div></div>;
}
